...
namespace web1.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Image,Description")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Image,Description")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();

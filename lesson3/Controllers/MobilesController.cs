...
namespace lab3.Controllers
{
    public class MobilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Model,Quantity,Image,Color,Video")] Mobile mobile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Model,Quantity,Image,Color,Video")] Mobile mobile)
        {
            if (id != mobile.Id)
            {
                return NotFound();
